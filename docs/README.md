...
The repository currently prioritizes accurate written documentation over recreating historical screenshots that do not exist.

Current-state screenshots will be added after sensitive details are sanitized. Their captions should explain what was validated or what operational problem the final interface solves rather than pretending they are before-and-after evidence.
